        ...
        for language in language_list:
            ...
            if "question_type" in output_dict[0]:
                ...
                for item in output_dict:
                    data_id, category, parsed_pred = item["question_id"], item["question_type"], item["prediction"]
                ...
                for item in answer_dict:
                    data_id, category, parsed_pred = item["question_id"], item["question_type"], item["ground_truth"],
