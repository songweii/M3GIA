...
MODEL_PATH = "/mnt/data/pretrain/pretrain_weight/cogvlm/cogvlm2-llama3-chinese-chat-19B"  # replace it with your own model path
...
def eval_model(args):
    ...
    for index, row in tqdm(dataset.iterrows(), total=len(dataset)):
        ...
        result_char = parse_multi_choice_response(question, choices, response, cur_option_char, index2ans, api_dict=openai_api_dict)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--answers-file", type=str, default="result/answer.jsonl", help="Path to save the output")
    ...
    args.model_name = 'cogvlm2-19B'  # Replace it with your own model's name.
