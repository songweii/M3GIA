...
def call_llava_engine_df(args, sample, model, tokenizer=None, processor=None, conv_mode=None):
    ...
    if conv_mode is None:
        ...
        if "llava" in model_name.lower():
            if 'llama-2' in model_name.lower():
                ...
                template_name = "qwen"
            elif "yi-34b" in model_name.lower() or "yi-6b" in model_name.lower():
                template_name = "llava_yi"
    ...
    if image is not None:
        output_ids = model.generate(
            input_ids,
            images=image.unsqueeze(0).bfloat16().cuda(),
            do_sample=True,
            temperature=1,
            top_p=None,
            num_beams=5,
